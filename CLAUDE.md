...
```
C:\Users\timlo\.claude\projects\D--AI-Notion-DeMark\memory\
```

The memory index is at:
```
C:\Users\timlo\.claude\projects\D--AI-Notion-DeMark\memory\MEMORY.md
```
...
At the end of each session, manually append an entry to `D:\AI\Notion-DeMark\SESSIONS.md`:
